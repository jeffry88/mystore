            ...
            <div class="container">
                <nav class="navbar navbar-inverse" role="navigation">
                    <div class="navbar-header">
                        ...
                        <a href="index.html" class="navbar-brand scroll-top"><em>J</em>store</a>
                    </div>
                    <!--/.navbar-header-->
                    <div id="main-nav" class="collapse navbar-collapse">
                        ...
                        <div id="main-sub-nav" style="position: relative;left:160px;">
                            <ul class="nav navbar-nav">
                        ...
                        <div style="width: 80px; height: 50px; position: relative; right: -106%; top: -31px;display:none;">
                            <a href="#"><img src="img/user01.png" height= 40px;></a>
                        </div>
                    </div>
                    <!--/.navbar-collapse-->
                </nav>
